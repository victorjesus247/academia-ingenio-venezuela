        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/agendar" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="btn-outline w-full">
                  Clase de Prueba Gratis
                </Button>
              </Link>
            </div>
            
            <div className="mt-8 flex items-center gap-4 flex-wrap justify-center sm:justify-start">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div 
                    key={i} 
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center"
                  >
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <div className="relative w-full max-w-md lg:max-w-lg">
              <div className="w-full aspect-square bg-gradient-to-tr from-ingenio-blue to-ingenio-green rounded-full opacity-10 absolute -z-10"></div>
              <img
                src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80"
                alt="Estudiantes colaborando"
                className="rounded-lg shadow-lg w-full"
              />
              <div className="bg-white p-2 sm:p-3 shadow-lg rounded-lg absolute -bottom-5 -left-5 flex items-center gap-2 sm:gap-3 text-xs sm:text-base">
